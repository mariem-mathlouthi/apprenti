<template>
    <div class="dashboard-container">
      ...
      <div class="main-content">
        <Navbar />
        <div class="add-domaine">
          <h2 class="animated-title">Ajouter un Nouveau Domaine</h2>
          
          <form @submit.prevent="addDomaine" class="form-container">
            <div class="form-group floating-label">
              <input 
                type="text" 
                id="description" 
                v-model="domaine.description" 
                required 
                placeholder=" "
                class="styled-input"
              />
              <label for="description">Description du domaine</label>
            ...
            <button 
              ...
              class="submit-button"
            >
              <span v-if="!loading">Créer le Domaine</span>
    ...
    methods: {
      async addDomaine() {
        ...
        try {
          ...
          this.errorMessage = "Erreur lors de l'ajout du domaine.";
          toast.error(this.errorMessage, { autoClose: 2000 });
        } finally {
          this.loading = false;
        }
        setTimeout(() => {
          this.$router.push('/DomaineList');
        }, 2000);
      }
    }
  };
