<template>
    <div class="dashboard-container">
      ...
      <div class="main-content">
        <Navbar />
        <div class="add-secteur">
          <h2 class="animated-title">Ajouter un Nouveau Secteur</h2>
          
          <form @submit.prevent="addSecteur" class="form-container">
            <div class="form-group floating-label">
              <input 
                type="text" 
                id="description" 
                v-model="secteur.description" 
                required 
                placeholder=" "
                class="styled-input"
              />
              <label for="description">Description du secteur</label>
            ...
            <button 
              ...
              class="submit-button"
            >
              <span v-if="!loading">Créer le Secteur</span>
    ...
    methods: {
      async addSecteur() {
        ...
        try {
          ...
          setTimeout(() => {
            this.$router.push('/SecteurList');
          }, 2000);
  
        } catch (error) {
          this.errorMessage = error.response?.data?.message || "Erreur lors de l'ajout du secteur";
