      ...
      <div
        ...
        <div class='flex items-center space-x-26'>
          ...
          <div class="relative cursor-pointer" @click="goToNotifications">
            <svg xmlns="http://www.w3.org/2000/svg" width="20px" class="fill-[#333] hover:fill-[#077bff] transition-colors duration-300"
            ...
            <span v-if="notifications.length > 0" class="flex items-center justify-center h-4 w-4 bg-red-600 rounded-full text-white text-xs font-bold absolute -top-2 -right-1 transform scale-100 transition-transform duration-300 hover:scale-110">{{ notifications.length }}</span>
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      goToNotifications() {
        ...
        // Reset notifications counter globally
        this.notifications = [];
