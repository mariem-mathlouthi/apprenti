<template>
    <div class="dashboard-container">
      ...
      <div class="main-content">
        <Navbar />
        <div class="add-type-stage">
          <h2 class="animated-title">Ajouter un Nouveau Type de Stage</h2>
          
          <form @submit.prevent="addTypeStage" class="form-container">
            <div class="form-group floating-label">
              <input 
                type="text" 
                id="description" 
                v-model="typeStage.description" 
                required 
                placeholder=" "
                class="styled-input"
              />
            ...
            <button 
              ...
              class="submit-button"
            >
              <span v-if="!loading">Créer le Type</span>
    ...
    methods: {
      async addTypeStage() {
        ...
        try {
          ...
          this.typeStage.description = "";
          
          setTimeout(() => {
            this.$router.push('/TypeStageList');
          }, 2000);
          
        } catch (error) {
          this.errorMessage = error.response?.data?.message || "Erreur lors de l'ajout du type de stage";
